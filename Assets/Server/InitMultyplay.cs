...
public class InitMultiplay : MonoBehaviour
    {
        ...
        private async void Awake()
        {
            ...
            _serverQueryHandler = await MultiplayService.Instance.StartServerQueryHandlerAsync(DefaultMaxPlayers, DefaultServerName, DefaultGameType, DefaultBuildId, DefaultMap);
