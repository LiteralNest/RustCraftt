...
namespace Mesh
{
	...
	public class MeshCombinerEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			UnityEngine.Mesh mesh = meshCombiner.GetComponent<MeshFilter>().sharedMesh;
		...
		private string SaveCombinedMesh(UnityEngine.Mesh mesh, string folderPath)
		{
			...
			if(!meshIsSaved)
			{
				...
				int assetNumber = 1;
				while(AssetDatabase.LoadAssetAtPath(meshPath, typeof(UnityEngine.Mesh)) != null) // If Mesh with same name exists, change name.
				{
